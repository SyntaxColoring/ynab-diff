...
export function FileInput(props: Props): React.JSX.Element {
  return (
    ...
    <input
      type="file"
      className="cursor-pointer file:mr-2 file:cursor-pointer file:rounded-xs file:border-2 file:border-stone-700 file:bg-stone-200 file:px-4 file:py-0.5 file:hover:bg-stone-400"
      {...props}
    />
  );
}
